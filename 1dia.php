<?php
  ...
  foreach ($resSql as $result) {
    ...
    $content .= '                <p style="letter-spacing: 1px;font-size:16px; color:#5b5a5a; margin-bottom:30px; margin-top:0px">Seu acesso expira amanhã. Vencimento <strong>'.$dataFull.'</strong>.</p>';
